...
@NamedQueries({
    ...
    @NamedQuery(name = "Discount.findByExpiresAt", query = "SELECT d FROM Discount d WHERE d.expiresAt = :expiresAt")})
public class Discount implements Serializable {
    ...
    public Discount(Integer id, String code, int percentage) {
        this.id = id;
        this.code = code;
